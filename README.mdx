...
![theatre-aueb-cover](static/img/logo-512x512.png)
...
From there, the project was extensively modified to reflect the design, content, and branding needs of the theatre.aueb.gr site.

## 📦 Package Manager
This repository uses npm as the package manager and keeps dependencies locked with `package-lock.json`.
...
## 🍴 Forking this repo
You are welcome to fork and use this repo as you wish for your team, however, it would be really kind if you give us credit by including a link back to our website at [theatre.aueb.gr](https://theatrikiopa.vercel.app). Additionally, if you could also leave a 🌟, it would be greatly appreciated. Thank you!
