...
description: Μία σπονδυλωτή παράσταση για την αναζήτηση της ευτυχίας, βασισμένη σε 15 αληθινές ιστορίες ανθρώπων από όλη την Ελλάδα. Ένα έργο του Γιάννη Καλαβριανού για τη μνήμη, τον πόλεμο, τη μετανάστευση, τους έρωτες και τις μικρές στιγμές που μας καθορίζουν.
image: /img/gioi-kai-kores-tou-gianni-kalavrianou/cover.png
---
